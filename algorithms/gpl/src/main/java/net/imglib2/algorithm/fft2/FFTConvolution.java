...
public class FFTConvolution< R extends RealType< R > >
{
	 ...
	 */
	public FFTConvolution( final Img< R > img, final Img< R > kernel, final ExecutorService service )
	{
	 ...
	 * @return - the new ExecutorService
	 */
	public static final ExecutorService createExecutorService( final int nThreads )
	{
